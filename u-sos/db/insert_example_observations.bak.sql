...
INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:44', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', '10.1');
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-04');

INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:45', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', '12.0');
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-04');

INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:46', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', '10.5');
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-04');

INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:47', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', '9.2');
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-05');

INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:51', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', null);
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-05');

INSERT INTO observation (time_stamp, procedure_id, feature_of_interest_id,phenomenon_id,offering_id,text_value)
	VALUES ('2008-04-01 17:43', 'urn:ogc:object:feature:Sensor:IFGI:ifgi-sensor-2', 'foi_2001','urn:ogc:def:phenomenon:OGC:1.0.30:waterspeed','WATER_SPEED', 11.2);
INSERT INTO obs_unc (observation_id, uncertainty_id)
	VALUES (currval(pg_get_serial_sequence('observation','observation_id')), 'uncID-05');
