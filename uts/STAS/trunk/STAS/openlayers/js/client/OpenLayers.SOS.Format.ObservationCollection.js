...
OpenLayers.SOS.Format.ObservationCollection = OpenLayers.Class(OpenLayers.Format.XML, {
		...
		generateFeatures: function (obs, eP) {
			...
			for (key in mapping) {
				...
				features.push(new OpenLayers.SOS.ObservationSeries(
					id, geometry, eP, procedure, observedProperty, uom, values
				));
			}
			return features;
		},
