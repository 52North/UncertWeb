 ...
 */
OpenLayers.Format.SLD.Custom = OpenLayers.Class(OpenLayers.Format.Filter.v1_0_0, {
    ...
    writers: OpenLayers.Util.applyDefaults({
        "sld": {
            "StyledLayerDescriptor": function(sld) {
				...
				var xsi = "http://www.w3.org/2001/XMLSchema";
				//root.setAttribute("xmlns:xsi", xsi)
                root.setAttribute("xmlns:sld", this.namespaces.sld);
				//root.setAttribute("xsi:schemaLocation", this.namespaces.sld +" "+ this.schemaLocation);
