...
OpenLayers.SOS.ObservationSeries = OpenLayers.Class(OpenLayers.Feature.Vector, {
		...
		getProcedure: function() { return this.attributes.procedure; },
		getValues: function() { return this.attributes.timeValueArray; },
		getValue: function(){ return this.attributes.resultValue; },
		isMultiFeature: function() { return this.attributes.isMultiFeature; },
	});
