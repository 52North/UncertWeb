...
public class StyleGenerator {
	...
	public StyledLayerDescriptorDocument getSld() {
		...
		ColorMap map = ((RasterSymbolizer) nl
							...
							.addNewRule()
							.addNewSymbolizer()
							.substitute(Namespace.SLD.q("RasterSymbolizer"), RasterSymbolizer.type))
								.addNewColorMap();
		...
		class MapEntry {
			Color c; double o; double q;
			public MapEntry(Color c, double o, double q) {
				this.c = c; this.o = o; this.q = q;
			}
		}
	...
	public static void main(String[] agrs) {
		System.out.println(new StyleGenerator(10,300,10).getSld().xmlText(defaultOptions()));
	}
