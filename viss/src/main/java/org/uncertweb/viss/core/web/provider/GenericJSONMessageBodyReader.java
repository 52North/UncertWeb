 ...
 */
@Provider
public class GenericJSONMessageBodyReader implements MessageBodyReader<JSONObject> {

    private static final Logger log = LoggerFactory.getLogger(GenericJSONMessageBodyReader.class);
