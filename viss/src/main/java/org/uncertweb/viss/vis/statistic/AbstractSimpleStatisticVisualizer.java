...
public abstract class AbstractSimpleStatisticVisualizer extends
	...
	public static class StandardDeviationStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.COEFFICIENT_OF_VARIATION)
	@Description("Returns the coefficient of variation.")
	public static class CoefficientOfVariationStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.CORRELATION)
	@Description("Returns the correalation")
	public static class CorrelationStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.KURTOSIS)
	@Description("Returns the kutosis.")
	public static class KurtosisStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.MEAN)
	@Description("Returns the mean.")
	public static class MeanStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.MEDIAN)
	@Description("Returns the median.")
	public static class MedianStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.MODE)
	@Description("Returns the mode.")
	public static class ModeStatistic extends AbstractSimpleStatisticVisualizer {}

	@Type(UncertaintyType.SKEWNESS)
	@Description("Returns the skewness.")
	public static class SkewnessStatistic extends AbstractSimpleStatisticVisualizer {}
}
