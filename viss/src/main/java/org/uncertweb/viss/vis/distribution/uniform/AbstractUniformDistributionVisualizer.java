 ...
 */
package org.uncertweb.viss.vis.distribution.uniform;
...
public abstract class AbstractUniformDistributionVisualizer extends
		AbstractAnnotatedUncertaintyViusalizer {
	@Override
	public double evaluate(IUncertainty u) {
		return evaluate((UniformDistribution) u);
	}

	protected abstract double evaluate(UniformDistribution d);
}